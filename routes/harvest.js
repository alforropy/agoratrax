...
router.post(
  ...
  [
    ...
    check('viewmodal_harvest_geolocation', 'Harvest GeoLocation value is not valid')
      ...
      .trim()
      .escape(),
    check('viewmodal_harvest_quantity', 'El valor de la cantidad de cosecha no es válido')
      .not()
      .isEmpty()
      .trim()
      .escape(),
            ...
            if (error) {
              ...
              models.FoodprintHarvest.create(harvest_entry)
                ...
                .catch(err => {
                  ...
                  // redirect to Registro de Cosecha page
                  res.redirect('/app/harvest');
                });
            }
          });
      ...
      models.FoodprintHarvest.findAll({
        ...
        order: [['pk', 'DESC']],
          ...
          .then(rows => {
            ...
            pdfService.buildPDF(
                `ENTRADAS DE MASTER HARVEST GENERADAS POR EL ADMINISTRADOR ${username} ${useremail}
